            ...
            <div className="lg:w-2/5 lg:pr-24 md:mb-0 flex flex-col items-start mb-16 text-left">
              ...
              <div className="lg:mt-6 max-w-7xl sm:flex mt-0">
                <div className="sm:mt-0 mt-3">
                  <Link to="https://sarafemas.net/67359998259/checkouts/ce329580d2129dc73cfbb04ddfe256a2?channel=buy_button" className="hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 items-center block px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-green-500">
                    Lihat Harga
                  </Link>
                </div>
              </div>
